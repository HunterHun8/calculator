...
class Window(QWidget):
    def __init__(self):
        ...
        self.b_add.clicked.connect(lambda: self.addText("+"))
        ...
        self.b_sub.clicked.connect(lambda: self.addText("-"))
        self.b_mult.clicked.connect(lambda: self.addText("*"))
        ...
        self.b_div.clicked.connect(lambda: self.addText("/"))
